...
//there are no duplicate values (more than one element in the array that has the 
//same value as another). If there are any duplicates, the function should return false.
...
function hasCertainValue (arr, key, someVal) {
    return arr.every(function (val) {
